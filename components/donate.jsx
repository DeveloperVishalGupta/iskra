...
//   const [paymentMethod, setPaymentMethod] = useState('qr'); // 'qr' or 'bank'
...
//       <h1 className="text-3xl font-bold text-center text-gray-800 mb-2">Complete Your Payment 💳</h1>
//       <p className="text-center text-gray-500 mb-8">Choose a payment method below.</p>
...
//         {paymentMethod === 'qr' ? (
//           <div>
//             <p className="text-gray-600">Scan the QR code with any UPI app.</p>
//             {/* IMPORTANT: Replace this with your actual QR code image URL */}
//             <img
//               src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=upi://pay?pa=your-upi-id@okhdfcbank"
//               alt="Payment QR Code"
//               className="w-64 h-64 mx-auto my-5 p-2 border rounded-lg"
//             />
//             <p className="text-sm text-gray-600">
//               Or pay to UPI ID: <strong className="font-mono">your-upi-id@okhdfcbank</strong>
//             </p>
//           </div>
//         ) : (
//           <div className="text-left">
//             <p className="text-gray-600 text-center mb-6">Use the details below for NEFT, IMPS, or RTGS transfer.</p>
//             <ul className="space-y-4">
//               {Object.entries(bankDetails).map(([key, value]) => (
//                 <li key={key} className="flex justify-between items-center bg-gray-50 p-4 rounded-lg">
...
//                     <button onClick={() => copyToClipboard(value)} className="text-xs py-1 px-3 bg-gray-200 text-gray-700 font-medium rounded-md hover:bg-gray-300 transition-colors">
//                       Copy
//                     </button>
//                   </div>
//                 </li>
...
//        {/* Footer Note */}
//        <div className="mt-8 text-center text-sm text-gray-500 bg-slate-50 p-4 rounded-lg border border-dashed border-gray-300">
//           <p>After payment, please send a screenshot of the transaction to <strong className="text-gray-700">support@yourwebsite.com</strong>.</p>
//       </div>
//     </div>
//   );
// };
